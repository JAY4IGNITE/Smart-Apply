...
from app.routers import ai, interview, tailor, jobs, projects, cover_letter, linkedin, skills, github
...
async def lifespan(app: FastAPI):
    """Startup / shutdown lifecycle for AI Engine Service."""
...
app = FastAPI(
    title="Smart Apply - AI Engine Service",
    description="AI backend microservice for NVIDIA LLM processing, AI resume tailoring, and mock interviews.",
    version="1.0.0",
    lifespan=lifespan,
)
